...
export default function RecipeScreen({navigation}) {  
  ...
  const RecipeList = [
    {
      ...
      "ingredients": "1 (10 pound) fully-cooked, bone-in ham,2 teaspoons whole cloves,1/4 teaspoon ground cinnamon,2 tablespoons brown mustard,1/2 cup packed brown sugar,1/4 cup packed brown sugar,2 tablespoons apple cider vinegar,1 cup peach nectar,1 cup peach preserves,5 cups frozen peach slices,2 teaspoons minced fresh ginger root,1 hot cherry pepper, seeded and minced,1 (3 inch) cinnamon stick",
      "score": "0.241",
      "url": "https://www.allrecipes.com/recipe/102269/glazed-ham-with-peach-ginger-sauce/"
  },
  {
      "recipe": "Basic Fruit Smoothie",
      "ingredients": "1 quart strawberries, hulled,1 banana, broken into chunks,2 peaches,1 cup orange-peach-mango juice,2 cups ice",
      "score": "0.214",
      "url": "https://www.allrecipes.com/recipe/23553/basic-fruit-smoothie/"
  },
  {
      "recipe": "Puppy Chow",
      "ingredients": "9 cups crispy rice cereal squares,1/2 cup peanut butter,1 cup semi-sweet chocolate chips,1 1/2 cups confectioners' sugar",
      "score": "0.211",
      "url": "https://www.allrecipes.com/recipe/15820/puppy-chow/"
  },
  {
      "recipe": "White Chocolate Party Mix",
      "ingredients": "1 pound white chocolate,3 cups crispy rice cereal squares,3 cups crispy corn cereal squares,3 cups toasted oat cereal,2 cups thin pretzel sticks,2 cups peanuts,1 (12 ounce) package mini candy-coated chocolate pieces",
      "score": "0.205",
      "url": "https://www.allrecipes.com/recipe/9511/white-chocolate-party-mix/"
  },
  {
      "recipe": "Easy Peach Cobbler with Canned Peaches",
      "ingredients": "2 (29 ounce) cans sliced peaches in juice,2 cups all-purpose flour,1 cup sugar,3/4 cup unsalted butter, softened,1 cup chopped pecans",
      "score": "0.194",
  ...
  return (
    <View style={styles.container}>
      ...
      <View><Text style={styles.selected}>Selected</Text><Text style={styles.unselected}>Unselected</Text></View>
        <FlatList data={RecipeList} style={styles.RecipeBox}
          renderItem={({item}) => {
